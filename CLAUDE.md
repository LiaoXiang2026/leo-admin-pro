...
**Lint errors on Windows (line endings):**
Ensure `core.autocrlf` is set correctly in Git config.

**pnpm install fails:**
Ensure you're using the correct Node version (20.19.0+, 22.18.0+, or 24.0.0+).
